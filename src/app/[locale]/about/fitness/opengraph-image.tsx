...
const content: Record<string, { title: string; subtitle: string }> = {
  en: { title: 'Fitness Journey', subtitle: 'Health · Wellness · Sustainable problem-solving mindset' },
  th: { title: 'เส้นทางฟิตเนส', subtitle: 'สุขภาพ · ความเป็นอยู่ที่ดี · แนวคิดการแก้ปัญหาอย่างยั่งยืน' },
};
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 4, background: 'linear-gradient(90deg, #ef4444, #f97316, #eab308)' }} />
