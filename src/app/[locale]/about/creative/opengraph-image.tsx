...
const content: Record<string, { title: string; subtitle: string }> = {
  en: { title: 'Creative Works', subtitle: 'Design experiments · Innovation · Art meets technology' },
  th: { title: 'ผลงานสร้างสรรค์', subtitle: 'การทดลองออกแบบ · นวัตกรรม · ศิลปะพบกับเทคโนโลยี' },
};
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 4, background: 'linear-gradient(90deg, #a855f7, #ec4899, #f43f5e)' }} />
