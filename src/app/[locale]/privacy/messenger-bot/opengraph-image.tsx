...
const content: Record<string, { title: string; subtitle: string }> = {
  en: { title: 'Messenger Bot Privacy', subtitle: 'Chatbot data protection · Automated messaging · User consent' },
  th: { title: 'นโยบายบอท Messenger', subtitle: 'การปกป้องข้อมูลแชทบอท · ข้อความอัตโนมัติ · ความยินยอมผู้ใช้' },
};
