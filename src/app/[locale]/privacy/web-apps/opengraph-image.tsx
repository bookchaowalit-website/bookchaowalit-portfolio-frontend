...
const content: Record<string, { title: string; subtitle: string }> = {
  en: { title: 'Web Apps Privacy', subtitle: 'App data protection · Cookies · User rights · Security' },
  th: { title: 'นโยบายความเป็นส่วนตัวเว็บแอป', subtitle: 'การปกป้องข้อมูลแอป · คุกกี้ · สิทธิผู้ใช้ · ความปลอดภัย' },
};
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 4, background: 'linear-gradient(90deg, #14b8a6, #06b6d4)' }} />

        <div style={{ fontSize: 48, zIndex: 1, marginBottom: 16 }}>🌐</div>
        <div style={{ fontSize: 48, fontWeight: 900, color: '#fff', letterSpacing: '-0.03em', textAlign: 'center', lineHeight: 1.1, zIndex: 1 }}>
          {c.title}
        </div>
